...
abstract class FlutterFlowTheme {
  ...
  late Color easyLevel;
  late Color mediumLevel;
  late Color hardLevel;
  late Color grayIcon;
  late Color gray200;
  late Color gray600;
  late Color black600;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF4D000);
  late Color secondary = const Color(0xFFFE9ED7);
  ...
  late Color easyLevel = Color(0xFFC88AE1);
  late Color mediumLevel = Color(0xFF97F1A0);
  late Color hardLevel = Color(0xFFF0AEAE);
